...
export function ModalPayment() {
 ...
 function COPY (){
  ...
  return (
    <>
      <S.Description1>
      <p> Escaneie o QRCODE abaixo com o app do seu banco e anexe o comprovante. Assim que o pagamento for confirmado, o redator iniciará a execução da atividade.</p>
      </S.Description1>
      <S.Descriptionsplit>
      ...
      <S.ButtonCopy onClick={handlecopy}><IoCopy size={20} color="#42A4EF"/><h3>46.021.642/0001-78</h3></S.ButtonCopy>
      </S.ContainerPadrao>
      <S.ContainerPadrao3>
      <h4>ou</h4>
      </S.ContainerPadrao3>
      ...
      <S.ButtonCopy onClick={handlecopy2} ><IoCopy size={20} color="#42A4EF"/><h3>deixaqueeufaco</h3></S.ButtonCopy>
      </S.ContainerPadrao>
      <hr/>
      <S.ContainerPadrao2>
      <h4>Valor à pagar</h4>
